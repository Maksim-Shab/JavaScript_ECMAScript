...
const newBooke = new Book("BookName1", "Author1", 123);
newBooke.displayInfo();
...
class Student {
    ...
    displayInfo() {
        console.log(`Name: ${this.name}, Age: ${this.age}, Grade: ${this.grade}th grade`);
    }
}

const student = new Student("John Smith", 16, 10);
student.displayInfo();